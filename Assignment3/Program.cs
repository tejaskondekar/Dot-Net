...
namespace Assignment3
{
    ...
    public abstract class Employee
    {
        ...
        public Employee(String Name = "Tejas", decimal Basic = 9000, short DeptNo = 2)
        {
            this.Name = Name;
            this.Basic = Basic;
            this.DeptNo = DeptNo;
    ...
    {
        public Manager(String Name = "Samrat", decimal Basic = 30000, short DeptNo = 1, string Designation = "Manager") : base(Name, Basic, DeptNo)
        {
    ...
    {
        public GeneralManager(String Name = "Tejas ", decimal Basic = 8000, short DeptNo = 1, String Designation = "Manager", String Perks = "None") : base(Name, Basic, DeptNo, Designation)
        {
    ...
    {
        public CEO(String Name = "Darshan ", decimal Basic = 50000, short DeptNo = 2) : base(Name, Basic, DeptNo)
        {
