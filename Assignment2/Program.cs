...
namespace Assignment2
{
    ...
    {
        public GeneralManager(String Name= "Sumedh ", decimal Basic= 8000 , short DeptNo=1,String Designation="Manager",String Perks="None") : base(Name, Basic, DeptNo, Designation)
        {
